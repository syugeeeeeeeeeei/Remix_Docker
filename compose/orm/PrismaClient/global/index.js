...
const config = {
  ...
  "inlineSchema": "// compose/orm/prisma/schema.prisma\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"/app/PrismaClient/global\" // ★既存: ここで出力先を指定\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\n// ★ここから追加\nmodel TestItem {\n  id        String   @id @default(uuid())\n  name      String\n  createdAt DateTime @default(now())\n}\n\n// ★ここまで追加\n",
  "inlineSchemaHash": "5cf443cedef4f5e2c371ebe70ff8e011ad504b15045364d97cc9dc9979d83f2c",
  "copyEngine": true
}
...
path.join(process.cwd(), "PrismaClient/global/libquery_engine-linux-musl-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "PrismaClient/global/schema.prisma")
